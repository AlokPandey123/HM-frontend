...
<div class="page">
  ...
  <div class="header">
    <div class="brand">
      ...
      <div>
        <div class="brand-name">Sunrise IVF Center</div>
  ...
  <div class="footer">
    ...
    <div class="thank-you">
      <p>Thank you!</p>
      <span>We appreciate your trust in Sunrise IVF Center</span>
    </div>
  </div>

  <div class="watermark">Generated by Sunrise IVF Center &bull; ${new Date().toLocaleString('en-IN')}</div>
</div>
